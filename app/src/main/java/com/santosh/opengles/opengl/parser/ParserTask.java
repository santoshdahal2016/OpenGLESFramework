package com.santosh.opengles.opengl.parser;
 ...
 * @author santosh
 */
public abstract class ParserTask extends AsyncTask<Void, Integer, List<Model>> {
     ...
     *
	 */
	public ParserTask(Activity parent, Uri uri, Callback callback) {
		this.uri = uri;
	...
	protected abstract List<Model> build() throws Exception;

	protected abstract void build(List<Model> data) throws Exception;
    ...
    public interface Callback {
        ...
        void onLoadComplete(List<Model> data);
    }
}